// Register.jsx (Updated for Alveoly)
...
const Register = () => {
  ...
  useEffect(() => {
    ...
    const loginWithToken = async () => {
      try {
        ...
        setError(err.response?.data?.message || err.message || "OAuth registration failed");
      }
    };
    loginWithToken();
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
      ...
      // Send to backend Google OAuth register endpoint
        ...
        >
          ...
          <div className="hidden md:flex md:w-1/2 items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-800">Join Alveoly!</h3>
            ...
            <div className="mb-4 text-center">
              ...
              {googleLoading && (
                <div className="flex items-center justify-center gap-2 text-gray-500">
                  ...
                  <p className="text-sm">Signing up with Google...</p>
                </div>
              )}
            </div>
